    ...
    <div className="confirmation-container">
      <div className="confirmation-scroll">
        ...
        <div className="navigation-tabs">
          <button type="button" className="nav-tab">
            <div className="nav-icon active">
              <span className="icon"><CardHeading size={28} /></span>
            </div>
          </button>
          <button type="button" className="nav-tab">
            <div className="nav-icon">
              <span className="icon"><CarFrontFill size={28} /></span>
            </div>
          </button>
          <button type="button" className="nav-tab">
            <div className="nav-icon">
              <span className="icon"><House size={28} /></span>
            </div>
          </button>
        </div>
        ...
        <div className="order-status">
          ...
          <p className="status-message">We&apos;ll notify you once your driver has been assigned.</p>
        </div>
      </div>
    </div>
  );
